...
>>>>>>> 1fe070c (add: status table/ friend table, member多對多關聯)
...
<<<<<<< HEAD
                ('vip_user', models.CharField(default='', max_length=50)),
                ('vip_date_expiry', models.DateTimeField(blank=True, null=True)),
